...
final List<GameMode> gameModes = [
  ...
  GameMode(
    ...
    unlockOrder: 1, // Unlock after 2 Club Quizzes - fun casual mode
  ),
  GameMode(
    id: 'survival_mode',
    name: 'Survival Mode',
    ...
    unlockOrder: 2, // Unlock after 3 Higher or Lower wins - harder mode
  ),
  GameMode(
    ...
    unlockOrder: 3, // Unlock after 5 Survival streak
  ),
  GameMode(
